...
#  show: If True, the generated figure is shown.


def display(global_title, images, show=True, save=False):
...
#   show: If True, they are shown.
def display_sequential(global_title, images, show=True, save=False):
	global OUTPUT_FOLDER
